// eslint-disable-f @typescript-eslint/ban-ts-comment
// @ts-ignore
type Maybe<T> = T | null;
...
type ResponseStatus = "HAS_NO_RESPONSE" | "HAS_RESPONSE";

type ResponseType = "attachment" | "text";
...
type RoleType = "ADMIN" | "CUSTOMER" | "EDITOR" | "WRITER";
...
type Type = "ARTICLE" | "BIBLIOGRAPHY" | "ESSAY" | "PROMPT" | "REVIEW";
...
type WritingStyle = "APA6" | "APA7" | "HARVARD" | "MLA";
