...
const ContentWrapper = React.forwardRef<typeof Box, ContentProps>(
    function ContentWrapper({...props}: ContentProps, ref) {
        return <Box {...props} ref={ref}/>;
    }
);
const Content = styled(ContentWrapper)<ContentProps>`
