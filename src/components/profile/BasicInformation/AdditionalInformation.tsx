...
import {LoggedInUserDocument, User, UserUpdatePayload, useUpdateUserMutation,} from "../../../generated";
import {useLoggedInUserQuery} from "../../../generated/index";
    ...
    const formik = useFormik<User>({
        ...
        onSubmit: async (values: User) => {
            const payload: UserUpdatePayload = {
                ...
                timezone: {
                    abbr: values.timezone?.abbr,
                    isdst: values.timezone?.isdst,
                    offset: values.timezone?.offset,
                    text: values.timezone?.text,
                    utc: values.timezone?.utc,
                                            ...
                                            <Card>
                                                <CardContent>
                                                    <Grid container direction={"column"} gap={4}>
                                                        ...
                                                        {!isMobile && <Grid item textAlign={"end"}>
                                                            <Button
